  ...
  return (
    <div className="min-h-screen w-full text-slate-900 dark:text-white pb-20 transition-colors duration-300">
      <header
        ...
        style={{
          backgroundImage: 'linear-gradient(90deg, rgba(255, 250, 244, 0.72) 0%, rgba(243, 223, 155, 0.9) 20%, rgba(237, 30, 37, 0.98) 50%, rgba(243, 223, 155, 0.9) 80%, rgba(255, 250, 244, 0.72) 100%)'
        }}
      >
