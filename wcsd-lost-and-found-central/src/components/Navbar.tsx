            ...
            {showSettingsMenu && (
              <div className="absolute top-full right-0 mt-2 w-64 bg-[#e7a39b] border-2 border-[#f3df9b] rounded-2xl p-4 shadow-2xl animate-fade-in z-[70]">
                ...
                <div className="space-y-2 mb-4">
                  <button onClick={() => setIsDarkMode(!isDarkMode)} className="w-full flex items-center justify-between p-2 rounded-xl hover:bg-[#f3df9b] transition-colors group">
                  ...
                  <button onClick={() => setShowDoodles(!showDoodles)} className="w-full flex items-center justify-between p-2 rounded-xl hover:bg-[#f3df9b] transition-colors group">
                    <div className="flex items-center gap-3">
                  ...
                  {isDarkMode && (
                    <button onClick={() => setNeonMode(!neonMode)} className="w-full flex items-center justify-between p-2 rounded-xl hover:bg-[#f3df9b] transition-colors group">
                      <div className="flex items-center gap-3">
                  ...
                  <button onClick={() => setGlassMode(!glassMode)} className="w-full flex items-center justify-between p-2 rounded-xl hover:bg-[#f3df9b] transition-colors group">
                    <div className="flex items-center gap-3">
